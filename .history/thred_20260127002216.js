// thred.js (CDN version - browserKey as query param for enrich/page-view, proxied FP)
...
(function () {
    ...
    function proceedWithFingerprint(fingerprint, browserKey) {
      // GET config with browserKey as query param
      fetch(`${CONFIG_ENDPOINT}?browserKey=${encodeURIComponent(browserKey)}`, {
        ...
        .then((config) => {
          ...
          // Track page-view event on arrival
    ...
    function trackPageView(fingerprint, browserKey) {
      ...
      fetch(`${PAGE_VIEW_ENDPOINT}?browserKey=${encodeURIComponent(browserKey)}`, {
        method: "POST",
        headers: {
