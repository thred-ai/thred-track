...
(function () {
  ...
  function handleFormSubmit(event, config) {
    ...
    console.log("[Thred] Form:", form);
    const formData = new FormData(form);

    console.log("[Thred] email field:", config.emailId);
    console.log("[Thred] name field:", config.nameId);
    console.log("[Thred] company field:", config.companyId);
    console.log(config)

    const email = formData.get(config.emailId)?.trim() || null;
    const name = formData.get(config.nameId)?.trim() || null;
    const company = formData.get(config.companyId)?.trim() || null;

    console.log("[Thred] Form data:", email, name, company);
